    ...
    <div className="flex min-h-[75vh] items-center justify-center">
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-200/90 bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-4 text-xs">
          <div>
            <label htmlFor="operator-email" className="block text-slate-700 mb-1.5 font-semibold">Operator Email</label>
            <input
              id="operator-email"
              type="email"
              value={email}
          ...
          <div>
            <label htmlFor="operator-password" className="block text-slate-700 mb-1.5 font-semibold">Password</label>
            <input
